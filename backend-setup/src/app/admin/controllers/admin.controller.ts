...
export async function IS_ADMIN(req:AuthenticatedRequest, res:Response):Promise<Response>{
...
export async function ADMIN_GET_ALL_SHOWS_CONTROLLER (req:AuthenticatedRequest, res:Response){
